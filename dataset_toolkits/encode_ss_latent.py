...
import scenegen.models as models
...
if __name__ == '__main__':
    ...
    parser.add_argument('--enc_pretrained', type=str, default='/GPFS/data/yanxumeng/yanxumeng/SceneTRELLIS/TRELLIS-image-large/ckpts/ss_enc_conv3d_16l8_fp16',
